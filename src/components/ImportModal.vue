    ...
    <div class="fixed inset-0 z-50 overflow-y-auto">
      <div class="flex items-center justify-center min-h-screen p-4">
        ...
        <Transition name="slide-up" appear>
          <div class="relative inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl sm:max-w-lg w-full max-h-[90vh] overflow-y-auto relative z-10">
